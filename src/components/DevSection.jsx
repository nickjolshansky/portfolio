...
const DevSection = () => (
  <section className="dev-section" id="dev">
    <div className="dev-content">
      <h2 className="section-title fadein" style={{ "--fadein-delay": "0s" }}>
      ...
      <div className="dev-grid">
        ...
        <div className="dev-card">
          <h3>
            <span className="dev-icon">💻</span>Full-Stack Development
          </h3>
          <p>
            Experienced in building and integrating modern web applications, from dynamic React frontends to robust Java/Spring and Node.js backends. Proficient
            in RESTful API design, ORM integration, and database management.
          </p>
        </div>
        <div className="dev-card">
          <h3>
            <span className="dev-icon">🤖</span>Automation & AI
          </h3>
        ...
        <div className="dev-card right-highlight">
          <h3>
            <span className="dev-icon">🛒</span>E-commerce & Integrations
          </h3>
          <p>
            Developed custom Shopify solutions, managed multi-marketplace product catalogs, and built integrations with warehouse, shipping, and third-party
            platforms.
          </p>
        </div>
        <div className="dev-card right-highlight">
          <h3>
            <span className="dev-icon">📃</span>Testing & QA
          </h3>
      ...
      <div className="skills-grid">
        ...
        <div className="skills-col">
          ...
          <ul className="skills-list">
            ...
            <li>VS Code</li>
            <li>Postman / Thunder Client / Swagger</li>
            <li>Shopify</li>
